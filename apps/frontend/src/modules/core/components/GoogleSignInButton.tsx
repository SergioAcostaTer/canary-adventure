...
export default function GoogleSignInButton() {
    ...
    onSuccess: async (tokenResponse) => {
      ...
      try {
        ...
        if (!res.ok) {
          ...
          throw new Error(err.message || "Error al autenticar con el backend");
        }
  ...
  return (
    <div className="space-y-4">
      {error && (
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 text-red-700 text-sm relative">
          {error}
          <button
